...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index2.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Projects</a></div>
    </div>
 <div class="row-fluid">
    ...
    <div class="widget-box">
        <div class="container-fluid">
          ...
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5></h5>
            <span class="label label-info">Projects</span> </div>
    ...
    ?>
              ...
              <tbody>
                 <?php 
                $query= "SELECT *  FROM project_table $limit";
                ...
                <tr>
                 <td><?php echo $counter;?></td>
                  ...
                  <td><?php  echo $fetch['proj_details']; ?></td>
                  <td><?php  echo $fetch['proj_img']; ?></td>
                  <td><?php  echo $fetch['date']; ?></td>
                   <td><?php
                    $id2=$fetch['id'];
                    echo "<a href='projedit.php?po=$id2' class='btn btn-info'>Edit</a>";
                    ?></td>
                  <td>
                    <?php
                    $id=$fetch['id'];
                    echo "<a href='projdelete.php?rn=$id' class='btn btn-danger'>Delete</a>";
                    ?>
                  </td>
