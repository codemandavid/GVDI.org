...
if ($error !="") {
 ...
 // if everything is ok, try to upload file
   ...
   $sql = "INSERT INTO blog_table (blog_title, blog_details, blog_img, date)
VALUES ('$title', '$details', '$image' ,'$date')";
    
    if (mysqli_query($conn, $sql)) {
    $success= "You have successfully created Your News ";
} else {
        ...
        <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <textarea class="textarea_editor span12" rows="6" placeholder=" News Details ..." name="details"></textarea>
            </div>
