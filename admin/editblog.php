...
if (!$_POST['title']) {
    $error.="A News Title is required <br>";
    
}
if (!$_POST['details']) {
    $error.="News Details is required <br>";
...
if ($error !="") {
    ...
    $sql = "UPDATE blog_table SET blog_title ='$title',  blog_details ='$details' WHERE id = '".$id."'
    " ;

    if (mysqli_query($conn, $sql)) {
      $_SESSION['update'] = "<p class='alert alert-success'>You have successfully edited Your News</p>";
...
<html lang="en">
<head>
<title>Changing Lives Admin</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="index2.php">Changing Lives|Admin</a></h1>
</div>
<!--close-Header-part--> 
       ...
       $fetch= mysqli_fetch_array($run);
        ?>
          <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="News Title" name="title" value=" <?php echo $fetch['blog_title'];  ?> " />
              </div>
            </div>
         
            <div class="controls">
              <label class="control-label">News Details</label>
              <textarea class="textarea_editor span12" rows="6" placeholder=" News Details ..." name="details"> <?php echo $fetch['blog_details'];  ?></textarea>
            </div>
             
              <button type="submit" class="btn btn-success" name="submit">Edit News</button>
